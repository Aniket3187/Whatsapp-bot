...
faq_file = "MumbaiSpa.json"  # Upload this JSON file to your environment
...
prompt_template = PromptTemplate(
    ...
    template="""
You are a friendly and knowledgeable customer support assistant for Spa in mumbai.
...
if __name__ == "__main__":
    ...
    print("👉 Now run 'ngrok http 5000' in a separate terminal and update the webhook URL in Twilio.")
